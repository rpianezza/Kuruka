...
The input files are produced with deviaTE (remove .raw files from the folder before launching).
Creator Almo (modified by Riccardo)
'''
...
parser.add_argument('input', metavar='input', type=str,
                    help='path to input folder with all deviaTE outputs')
